...
$(function(){
    $("#upload").upload({
        action:"uploadAction_test.action",
        //上传请求
...
//         //     $.ajax({
//         //         type: "POST",
//         //         url: "/hnmccClientWap/dataking/getphone.do",
//         //         dataType: "json",
//         //         data: {},
//         //         async: true,
//         //         beforeSend: function () {
...
//     $.ajax({
//         type: "POST",
//         url: "/hnmccClientWap/llzc/order.do",
//         dataType: "json",
...
//             var redpack_balance = data.red_balance;
//             var reles_redpack_num = data.reles_redpack_num;
//             var acti_redpack_nu = data.acti_redpack_nu;
//             layer.closeAll();
//             switch (code) {
//                 case 0:
...
//                     $('#msg').html('订购套餐失败');
//                     $('#errmsg').html(msg);
//                     $('#redpack_balance').html(redpack_balance);
//                     $('#reles_redpack_num').html(reles_redpack_num);
//                     $('#acti_redpack_nu').html(acti_redpack_nu);
//                     $('#show').show();
//                     break;
//                 case 3:
//                     $('#msg').html('恭喜您，订购成功');
