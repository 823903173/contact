...
import com.hmcc.contact.entity.ExcelBean;
...
public class ExcelUtilContact {
         ...
         * Excel删除
         */
        public static List<List<Object>> getDeleteInfo(InputStream in, String fileName) throws Exception {
